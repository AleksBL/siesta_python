...
class SiP:
    ...
    def calculate_bulksurf_RSSE(self, Contour=None, supercell=None, init_grid_N=8, 
                                ...
                                save_to_file=True, return_calc=False,
                                nprocs=1, add_command='',reuse=False, debug_with_sisl=False,
                                pivot_start = None, start = "mpirun"):
        ...
        command =   start+" "+add_command+" calcbulkse "+\
        ...
        if reuse==False:
            os.system(command)
        Htot = sisl.get_sile('_tmp_se/Htot.TSHS').read_hamiltonian()
        Xidx = np.load('_tmp_se/coups_a.npy')
        ...
        if save_to_file:
            np.savez_compressed(self.dir+'/3D_bulk_SE.npz', 
                                SE=SE_v, H0=H0, S0=S0, xyz_elec=xyz_elec, 
